...
.medo-mod__ic--danger{ background: var(--medo-error-surface); color: var(--medo-error-accent); }
.medo-mod__ic--warning{ background: var(--medo-warning-surface); color: var(--medo-warning-accent); }
.medo-mod__ic--success{ background: var(--medo-success-surface); color: var(--medo-success-accent); }
