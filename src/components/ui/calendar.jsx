  ...
  return (
    <DayPicker
      ...
      components={{
        ...
        Chevron: ({ orientation }) => {
          if (orientation === "left") return <Icon name="chevron_left" size="1rem" />;
          if (orientation === "right") return <Icon name="chevron_right" size="1rem" />;
          return <Icon name="expand_more" size="1rem" />;
        },
        DayButton: ({ ...props }) => (
